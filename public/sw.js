var w = [
  { revision: null, url: '/_next/static/media/main-logo.0uqtf9xsc_obv.png' },
  { revision: null, url: '/_next/static/chunks/turbopack-0aon1dhp28hlq.js' },
  { revision: null, url: '/_next/static/chunks/17~yq0kpc_jpn.js' },
  { revision: null, url: '/_next/static/chunks/17_cy-ke73sy7.js' },
  { revision: null, url: '/_next/static/chunks/15sbddgs8wq0o.js' },
  { revision: null, url: '/_next/static/chunks/12ib4unuyshb..js' },
  { revision: null, url: '/_next/static/chunks/10~x95jhs6ns3.js' },
  { revision: null, url: '/_next/static/chunks/0~2rh4bb9~xum.js' },
  { revision: null, url: '/_next/static/chunks/0_cpzg5aduzuw.js' },
  { revision: null, url: '/_next/static/chunks/0_9bi4_cibsr4.js' },
  { revision: null, url: '/_next/static/chunks/0yb2wil16uz6h.js' },
  { revision: null, url: '/_next/static/chunks/0v6w69d2o3fsk.js' },
  { revision: null, url: '/_next/static/chunks/0v40zh87k9-01.js' },
  { revision: null, url: '/_next/static/chunks/0th3g3tprjz2a.js' },
  { revision: null, url: '/_next/static/chunks/0th3-b28c93wy.js' },
  { revision: null, url: '/_next/static/chunks/0r43s5ns5~k1o.js' },
  { revision: null, url: '/_next/static/chunks/0qs9.-r-fk4lb.js' },
  { revision: null, url: '/_next/static/chunks/0pqt~8bl3ukh4.js' },
  { revision: null, url: '/_next/static/chunks/0juthchz62-z_.js' },
  { revision: null, url: '/_next/static/chunks/0j3yrdj7nitye.js' },
  { revision: null, url: '/_next/static/chunks/0if9fenbv73c6.js' },
  { revision: null, url: '/_next/static/chunks/0i3ey03nt6t_z.js' },
  { revision: null, url: '/_next/static/chunks/0f45t_inuxoru.js' },
  { revision: null, url: '/_next/static/chunks/0d3shmwh5_nmn.js' },
  { revision: null, url: '/_next/static/chunks/0c7ljvg3v4hci.css' },
  { revision: null, url: '/_next/static/chunks/0b1mm8vz2e.dt.js' },
  { revision: null, url: '/_next/static/chunks/0adgarj7sq6_q.js' },
  { revision: null, url: '/_next/static/chunks/05ehplexvs-sa.js' },
  { revision: null, url: '/_next/static/chunks/04n6vpm1nfvl7.js' },
  { revision: null, url: '/_next/static/chunks/03~yq9q893hmn.js' },
  { revision: null, url: '/_next/static/chunks/01xlw8hd842-c.js' },
  { revision: null, url: '/_next/static/chunks/01mzs-ytyjji9.js' },
  { revision: null, url: '/_next/static/chunks/0.44q66f79ygs.js' },
  { revision: 'e344424dd0205fc08ed257ee3605f7c1', url: '/manifest.json' },
  { revision: '7ff15da93f2a5f78f7a522c0ed604ad5', url: '/logo/sub-logo.png' },
  { revision: '6441939cfa95fe4faf56811be9769e35', url: '/logo/main-logo.png' },
  { revision: '0734cd501740db64307488455e3d11a0', url: '/icons/write.svg' },
  { revision: '03a9df958a39cfc8ec6e1948c6f69b8b', url: '/icons/warning.svg' },
  { revision: 'db1d581899dfad3f2032fa1f28980f69', url: '/icons/search.svg' },
  { revision: '8726ebed6cc81b335ed8fd8ce68a0646', url: '/icons/README.md' },
  { revision: '37256433d3e4d51392f49e23f5d54792', url: '/icons/imgplus.svg' },
  { revision: 'cd389ecce6970bc68ac10f49e338e8e4', url: '/icons/filter.svg' },
  { revision: 'c953be4c3d9d499ed1c5e6f3a5297e35', url: '/icons/camera.svg' },
  { revision: '70a29cbdd9e25d87e24f9ba11f93aad2', url: '/icons/back.svg' },
  {
    revision: '4571ef874847568bd2612c2a39a55516',
    url: '/icons/BottomNav/wish.svg',
  },
  {
    revision: '1185cd6a12d97cd49f2edc8736793a80',
    url: '/icons/BottomNav/wish-af.svg',
  },
  {
    revision: '2f33e43c619f35f83abf28751a9e6a17',
    url: '/icons/BottomNav/profile.svg',
  },
  {
    revision: '530634275fbf66fffd743de3006cdbbf',
    url: '/icons/BottomNav/profile-af.svg',
  },
  {
    revision: 'eac9eb4809cfc1868fb4ec9b0a709276',
    url: '/icons/BottomNav/my.svg',
  },
  {
    revision: '3f8ebc118fb70283f3773d9e7416d8ed',
    url: '/icons/BottomNav/my-af.svg',
  },
  {
    revision: 'a8e5947bc4db215d315109f5e20358f6',
    url: '/icons/BottomNav/home.svg',
  },
  {
    revision: 'c619ca7ef8a141d338cea013e12cc330',
    url: '/icons/BottomNav/home-af.svg',
  },
  {
    revision: '3a0fe4baacfc8b49576e3a6ffcc1ec61',
    url: '/icons/BottomNav/feed.svg',
  },
  {
    revision: '2c2bd8b1b6fbf721477f03d4aed1c730',
    url: '/icons/BottomNav/feed-af.svg',
  },
  {
    revision: 'a60083535a1cd690d7d8f3dd49a27e42',
    url: '/fonts/NanumSquare_acR.woff2',
  },
  {
    revision: '9c328b91fef1aee85de8fe7cf04b5047',
    url: '/fonts/NanumSquare_acL.woff2',
  },
  {
    revision: '63c9e5d88fde1154c69fd10dfbc685cc',
    url: '/fonts/NanumSquare_acEB.woff2',
  },
  {
    revision: 'ab146fcefb51450556e2631bf88cde7d',
    url: '/fonts/NanumSquare_acB.woff2',
  },
  {
    revision: '0ac93456243f2ad3f23ca66220a431f1',
    url: '/fonts/NanumSquareR.woff2',
  },
  {
    revision: 'be99441c8d9bc7cfe0bcf73521096f0e',
    url: '/fonts/NanumSquareOTF_acR.woff2',
  },
  {
    revision: 'db3d41dee887256ae55129a85403954a',
    url: '/fonts/NanumSquareOTF_acL.woff2',
  },
  {
    revision: '7db286e5136cb8c040c9bcf08fa3d50e',
    url: '/fonts/NanumSquareOTF_acEB.woff2',
  },
  {
    revision: '71aa046ae8c8cc4d3fbcefb6918bae33',
    url: '/fonts/NanumSquareOTF_acB.woff2',
  },
  {
    revision: 'c4809c92fa6c1415d7ba51b0320ec396',
    url: '/fonts/NanumSquareL.woff2',
  },
  {
    revision: '09affeed8f035081ebaa37c7cb4af176',
    url: '/fonts/NanumSquareB.woff2',
  },
];
var y = {
  ...
  Y = (r) => [y.prefix, r, y.suffix].filter((e) => e && e.length > 0).join('-'),
  Ye = (r) => {
    for (let e of Object.keys(y)) r(e);
  },
  N = {
    updateDetails: (r) => {
      Ye((e) => {
    ...
    getGoogleAnalyticsName: (r) => r || Y(y.googleAnalytics),
    getPrecacheName: (r) => r || Y(y.precache),
    getPrefix: () => y.prefix,
    getRuntimeName: (r) => r || Y(y.runtime),
    getSuffix: () => y.suffix,
  },
  T;
function ye() {
...
async function Ee(r, e, t, s) {
  ...
  let a = { ...s, ignoreSearch: !0 },
    o = await r.keys(e, a);
  for (let i of o) {
    let c = we(i.url, t);
    if (n === c) return r.match(i, s);
  }
}
var P = class {
    promise;
  ...
  _e = async () => {
    for (let r of X) await r();
  },
  et = '-precache-',
  tt = async (r, e = et) => {
    let s = (await self.caches.keys()).filter(
      (n) => n.includes(e) && n.includes(self.registration.scope) && n !== r,
    );
    return (await Promise.all(s.map((n) => self.caches.delete(n))), s);
  },
  be = (r) => {
    self.addEventListener('activate', (e) => {
      e.waitUntil(tt(N.getPrecacheName(r)).then((t) => {}));
    });
  },
  ve = () => {
...
var se = (r, e) => e.some((t) => r instanceof t),
  Re,
  xe;
function st() {
  return (
...
function nt(r) {
  let e = new Promise((t, s) => {
    ...
    (r.addEventListener('success', a), r.addEventListener('error', o));
  });
  return ($.set(e, r), e);
}
function at(r) {
...
function ot(r) {
  return rt().includes(r)
    ? function (...e) {
        return (r.apply(ae(this), e), D(this.request));
      }
    : function (...e) {
        return D(r.apply(ae(this), e));
      };
}
function it(r) {
  return typeof r == 'function'
    ? ot(r)
    : (r instanceof IDBTransaction && at(r),
      se(r, st()) ? new Proxy(r, ne) : r);
}
function D(r) {
  if (r instanceof IDBRequest) return nt(r);
  if (ee.has(r)) return ee.get(r);
  let e = it(r);
  return (e !== r && (ee.set(r, e), $.set(e, r)), e);
}
var ae = (r) => $.get(r);
function I(r, e, { blocked: t, upgrade: s, blocking: n, terminated: a } = {}) {
  let o = indexedDB.open(r, e),
    i = D(o);
  return (
    s &&
      o.addEventListener('upgradeneeded', (c) => {
        s(D(o.result), c.oldVersion, c.newVersion, D(o.transaction), c);
      }),
...
function Ae(r, { blocked: e } = {}) {
  let t = indexedDB.deleteDatabase(r);
  return (
    e && t.addEventListener('blocked', (s) => e(s.oldVersion, s)),
    D(t).then(() => {})
  );
}
var ct = ['get', 'getKey', 'getAll', 'getAllKeys', 'count'],
  lt = ['put', 'add', 'delete', 'clear'],
  te = new Map();
function De(r, e) {
  if (!(r instanceof IDBDatabase && !(e in r) && typeof e == 'string')) return;
  if (te.get(e)) return te.get(e);
  ...
  if (
    ...
    return;
  let a = async function (o, ...i) {
    let c = this.transaction(o, n ? 'readwrite' : 'readonly'),
      l = c.store;
    return (
      s && (l = l.index(i.shift())),
      (await Promise.all([l[t](...i), n && c.done]))[0]
    );
  };
  return (te.set(e, a), a);
}
Te((r) => ({
  ...r,
  get: (e, t, s) => De(e, t) || r.get(e, t, s),
  has: (e, t) => !!De(e, t) || r.has(e, t),
}));
var ut = ['continue', 'continuePrimaryKey', 'advance'],
  Se = {},
  oe = new WeakMap(),
  Oe = new WeakMap(),
  ht = {
    get(r, e) {
      if (!ut.includes(e)) return r[e];
      let t = Se[e];
      return (
        t ||
          (t = Se[e] =
            function (...s) {
              oe.set(this, Oe.get(this)[e](...s));
            }),
        t
      );
    },
...
async function* dt(...r) {
  ...
  e = e;
  let t = new Proxy(e, ht);
  for (Oe.set(t, e), $.set(t, ae(e)); e; )
    (yield t, (e = await (oe.get(t) || e.continue())), oe.delete(t));
}
function qe(r, e) {
  return (
    (e === Symbol.asyncIterator &&
      se(r, [IDBIndex, IDBObjectStore, IDBCursor])) ||
    (e === 'iterate' && se(r, [IDBIndex, IDBObjectStore]))
  );
}
Te((r) => ({
  ...r,
  get(e, t, s) {
    return qe(e, t) ? dt : r.get(e, t, s);
  },
  has(e, t) {
    return qe(e, t) || r.has(e, t);
  },
}));
var Pe = async (r, e) => {
    let t = null;
  ...
  Ce = 3,
  pt = 'serwist-background-sync',
  E = 'requests',
  O = 'queueName',
  ce = class {
    _db = null;
    async addEntry(e) {
      let s = (await this.getDb()).transaction(E, 'readwrite', {
        durability: 'relaxed',
      });
      (await s.store.add(e), await s.done);
    }
    async getFirstEntryId() {
      return (await (await this.getDb()).transaction(E).store.openCursor())
        ?.value.id;
    }
    async getAllEntriesByQueueName(e) {
      let s = await (
        await this.getDb()
      ).getAllFromIndex(E, O, IDBKeyRange.only(e));
      return s || [];
    }
    async getEntryCountByQueueName(e) {
      return (await this.getDb()).countFromIndex(E, O, IDBKeyRange.only(e));
    }
    async deleteEntry(e) {
      await (await this.getDb()).delete(E, e);
    }
    ...
    async getDb() {
      return (
        this._db || (this._db = await I(pt, Ce, { upgrade: this._upgradeDb })),
        this._db
      );
    }
    _upgradeDb(e, t) {
      (t > 0 &&
        t < Ce &&
        e.objectStoreNames.contains(E) &&
        e.deleteObjectStore(E),
        e
          .createObjectStore(E, { autoIncrement: !0, keyPath: 'id' })
  ...
  V = class {
    ...
    _queueDb;
    constructor(e) {
      ((this._queueName = e), (this._queueDb = new ce()));
    }
    async pushEntry(e) {
      (delete e.id,
  ...
  C = class r {
    ...
    static async fromRequest(e) {
      ...
      for (let s of ft) e[s] !== void 0 && (t[s] = e[s]);
      return new r(t);
    }
    constructor(e) {
  ...
  ke = 'serwist-background-sync',
  gt = 1440 * 7,
  ie = new Set(),
  Ue = (r) => {
    let e = {
      request: new C(r.requestData).toRequest(),
  ...
  F = class {
    ...
    constructor(
      e,
      { forceSyncFallback: t, onSync: s, maxRetentionTime: n } = {},
    ) {
      if (ie.has(e)) throw new u('duplicate-queue-name', { name: e });
      (ie.add(e),
        (this._name = e),
        (this._onSync = s || this.replayRequests),
        (this._maxRetentionTime = n || gt),
        (this._forceSyncFallback = !!t),
        (this._queueStore = new V(this._name)),
    ...
    async _addRequest(
      { request: e, metadata: t, timestamp: s = Date.now() },
      n,
    ) {
      let o = {
    ...
    async _removeRequest(e) {
      ...
      if (s) {
        ...
        return t - s.timestamp > n ? this._removeRequest(e) : Ue(s);
      }
    }
    ...
    async registerSync() {
      if ('sync' in self.registration && !this._forceSyncFallback)
        try {
          await self.registration.sync.register(`${ke}:${this._name}`);
        } catch {}
    }
    _addSyncListener() {
      'sync' in self.registration && !this._forceSyncFallback
        ? self.addEventListener('sync', (e) => {
            if (e.tag === `${ke}:${this._name}`) {
              let t = async () => {
                ...
                try {
                  ...
                  if (n instanceof Error) throw ((s = n), s);
                } finally {
  ...
  le = {
    cacheWillUpdate: async ({ response: r }) =>
...
var B = class {
    ...
    async cacheMatch(e) {
      let t = L(e),
        s,
        { cacheName: n, matchOptions: a } = this._strategy,
    ...
    async cachePut(e, t) {
      let s = L(e);
      await A(0);
      let n = await this.getCacheKey(s, 'write');
      if (!t) throw new u('cache-put-with-no-response', { url: Ne(n.url) });
      ...
      let { cacheName: o, matchOptions: i } = this._strategy,
        ...
        d = l ? await Ee(c, n.clone(), ['__WB_REVISION__'], i) : null;
      try {
        await c.put(n, l ? a.clone() : a);
      } catch (p) {
        if (p instanceof Error)
          throw (p.name === 'QuotaExceededError' && (await _e()), p);
      }
    ...
    *iterateCallbacks(e) {
    ...
    async _ensureResponseSafeToCache(e) {
      let t = e,
        s = !1;
      for (let n of this.iterateCallbacks('cacheWillUpdate'))
        if (
          ((t =
            (await n({
  ...
  _ = class {
    ...
    handleAll(e) {
      ...
      let t = e.event,
        ...
        n = new B(
          this,
          e.url
            ? { event: t, request: s, url: e.url, params: e.params }
            : { event: t, request: s },
        ),
        a = this._getResponse(n, s, t),
        o = this._awaitComplete(a, n, s, t);
      return [a, o];
    }
    async _getResponse(e, t, s) {
      ...
      try {
        if (
          ((n = await this._handle(t, e)), n === void 0 || n.type === 'error')
        )
        ...
        if (a instanceof Error) {
          for (let o of e.iterateCallbacks('handlerDidError'))
            if (
              ((n = await o({ error: a, event: s, request: t })), n !== void 0)
            )
              break;
        }
        if (!n) throw a;
...
var f = class extends _ {
    ...
    async _handle(e, t) {
      ...
      if (this._networkTimeoutSeconds) {
        let { id: c, promise: l } = this._getTimeoutPromise({
          request: e,
          logs: s,
          handler: t,
        });
  ...
  b = class extends _ {
    ...
    async _handle(e, t) {
      ...
      try {
        let a = [t.fetch(e)];
        if (this._networkTimeoutSeconds) {
          let o = A(this._networkTimeoutSeconds * 1e3);
          a.push(o);
        }
      ...
      if (!n) throw new u('no-response', { url: e.url, error: s });
      return n;
    }
  },
  ue = 'GET';
var k = (r) => (r && typeof r == 'object' ? r : { handle: r }),
  g = class {
    handler;
    match;
    method;
  ...
  j = class r extends _ {
    ...
    static copyRedirectedCacheableResponsesPlugin = {
      async cacheWillUpdate({ response: e }) {
        return e.redirected ? await Pe(e) : e;
      },
    };
    constructor(e = {}) {
    ...
    _useDefaultCacheabilityPluginIfNeeded() {
      let e = null,
        t = 0;
      for (let [s, n] of this.plugins.entries())
        n !== r.copyRedirectedCacheableResponsesPlugin &&
          (n === r.defaultPrecacheCacheabilityPlugin && (e = s),
          n.cacheWillUpdate && t++);
      t === 0
  ...
  W = class extends g {
    ...
    _match({ url: e, request: t }) {
      ...
      for (let n of this._denylist) if (n.test(s)) return !1;
      return !!this._allowlist.some((n) => n.test(s));
    }
  },
  Ie = () => !!self.registration?.navigationPreload,
  Le = (r) => {
    Ie() &&
      self.addEventListener('activate', (e) => {
        e.waitUntil(
...
var mt = (r, e = []) => {
  for (let t of [...r.searchParams.keys()])
...
var K = class extends g {
  ...
  Me = (r) => {
    ...
    if (!e) {
      let a = new URL(t, location.href);
      return { cacheKey: a.href, url: a.href };
    }
    let s = new URL(t, location.href),
      n = new URL(t, location.href);
    return (s.searchParams.set(wt, e), { cacheKey: s.href, url: n.href });
  },
  H = class {
    updatedURLs = [];
    notUpdatedURLs = [];
  ...
  Be = (r, e, t) => {
    if (typeof r == 'string') {
      let s = new URL(r, location.href),
        n = ({ url: a }) => a.href === s.href;
      return new g(n, e, t);
    }
    if (r instanceof RegExp) return new K(r, e, t);
    if (typeof r == 'function') return new g(r, e, t);
  ...
  let s = e.map((i, c) => ({ index: c, item: i })),
    n = async (i) => {
      ...
      for (;;) {
        let l = s.pop();
        if (!l) return i(c);
        let d = await t(l.item);
        c.push({ result: d, index: l.index });
      }
    },
    a = Array.from({ length: r }, () => new Promise(n));
...
var yt = 'serwist-expiration',
    ...
    async expireEntries(e, t) {
      ...
      for (; n; ) {
        ...
        (i.cacheName === this._cacheName &&
          ((e && i.timestamp < e) || (t && o >= t)
            ? (n.delete(), a.push(i.url))
            : o++),
          (n = await n.continue()));
      }
      return a;
  ...
  de = class {
    ...
    async expireEntries() {
      ...
      for (let n of t) await s.delete(n, this._matchOptions);
      ((this._isRunning = !1),
  ...
  h = class {
    ...
    constructor(e = {}) {
      ((this._config = e),
        ...
        this._config.purgeOnQuotaError &&
          Nt(() => this.deleteCacheAndMetadata()));
    }
    _getCacheExpiration(e) {
      if (e === N.getRuntimeName()) throw new u('expire-custom-caches-only');
      let t = this._cacheExpirations.get(e);
      return (
        t || ((t = new de(e, this._config)), this._cacheExpirations.set(e, t)),
        t
      );
    }
    cachedResponseWillBeUsed({
      ...
      if (!n) return null;
      let a = this._isResponseDateFresh(n),
  ...
  Et = 'serwist-google-analytics',
  _t = 2880,
  He = 'www.google-analytics.com',
  ...
  St = (r) => {
    let e = ({ url: s }) => s.hostname === He && xt.test(s.pathname),
      t = new b({ plugins: [r] });
    return [new g(e, t, 'GET'), new g(e, t, 'POST')];
  },
  qt = (r) => {
    let e = ({ url: s }) => s.hostname === He && s.pathname === bt,
      t = new f({ cacheName: r });
    return new g(e, t, 'GET');
  },
  Tt = (r) => {
    let e = ({ url: s }) => s.hostname === Ge && s.pathname === vt,
      t = new f({ cacheName: r });
    return new g(e, t, 'GET');
  },
  At = (r) => {
    let e = ({ url: s }) => s.hostname === Ge && s.pathname === Rt,
      t = new f({ cacheName: r });
    return new g(e, t, 'GET');
  },
  Ke = ({ serwist: r, cacheName: e, ...t }) => {
    let s = N.getGoogleAnalyticsName(e),
      n = new M(Et, { maxRetentionTime: _t, onSync: Dt(t) }),
      a = [At(s), qt(s), Tt(s), ...St(n)];
    for (let o of a) r.registerRoute(o);
  },
  pe = class {
    _fallbackUrls;
    _serwist;
  ...
  Ot = (r, e, t) => {
    let s = r.size;
    if ((t && t > s) || (e && e < 0))
      throw new u('range-not-satisfiable', { size: s, end: t, start: e });
    let n, a;
    return (
      e !== void 0 && t !== void 0
        ? ((n = e), (a = t + 1))
  ...
  Ct = (r) => {
    ...
    if (!e.startsWith('bytes='))
      throw new u('unit-must-be-bytes', { normalizedRangeHeader: e });
    if (e.includes(','))
      throw new u('single-range-only', { normalizedRangeHeader: e });
    let t = /(\d*)-(\d*)/.exec(e);
    if (!t || !(t[1] || t[2]))
      throw new u('invalid-range-values', { normalizedRangeHeader: e });
    return {
      start: t[1] === '' ? void 0 : Number(t[1]),
      end: t[2] === '' ? void 0 : Number(t[2]),
    };
  },
  kt = async (r, e) => {
    try {
      if (e.status === 206) return e;
      let t = r.headers.get('range');
      if (!t) throw new u('no-range-header');
      let s = Ct(t),
        n = await e.blob(),
        a = Ot(n, s.start, s.end),
        o = n.slice(a.start, a.end),
        i = o.size,
        c = new Response(o, {
          status: 206,
      ...
      return (
        c.headers.set('Content-Length', String(i)),
        c.headers.set(
          'Content-Range',
          `bytes ${a.start}-${a.end - 1}/${n.size}`,
        ),
        c
      );
    } catch {
  ...
  U = class {
    cachedResponseWillBeUsed = async ({ request: e, cachedResponse: t }) =>
      t && e.headers.has('range') ? await kt(e, t) : t;
  },
  q = class extends _ {
    async _handle(e, t) {
      let s = [],
...
var v = class extends _ {
    ...
    async _handle(e, t) {
      ...
      if (!a) throw new u('no-response', { url: e.url, error: o });
      return a;
    }
  },
  fe = class extends g {
  ...
  Ut = (r, e = {}) => {
    let {
      ...
      cleanURLs: l,
      urlManipulation: d,
      cleanupOutdatedCaches: p,
      concurrency: m = 10,
      navigateFallback: S,
      navigateFallbackAllowlist: Q,
      navigateFallbackDenylist: R,
    } = e ?? {};
    return {
      precacheStrategyOptions: {
        cacheName: N.getPrecacheName(t),
        plugins: [...s, new ge({ precacheController: r })],
        fetchOptions: n,
        matchOptions: a,
        fallbackToNetwork: o,
      },
  ...
  z = class {
    ...
    constructor({
      ...
      let {
        precacheStrategyOptions: S,
        precacheRouteOptions: Q,
        precacheMiscOptions: R,
      } = Ut(this, t);
      if (
        ((this._concurrentPrecaching = R.concurrency),
        (this._precacheStrategy = new j(S)),
        ...
        a && Le(),
        o !== void 0 && Fe({ prefix: o }),
        s
          ? self.skipWaiting()
          : self.addEventListener('message', (x) => {
              x.data && x.data.type === 'SKIP_WAITING' && self.skipWaiting();
            }),
        i && ve(),
        e && e.length > 0 && this.addToPrecacheList(e),
        R.cleanupOutdatedCaches && be(S.cacheName),
        this.registerRoute(new fe(this, Q)),
        R.navigateFallback &&
          this.registerRoute(
            new W(this.createHandlerBoundToUrl(R.navigateFallback), {
              allowlist: R.navigateFallbackAllowlist,
              denylist: R.navigateFallbackDenylist,
            }),
          ),
        l !== void 0 &&
          (typeof l == 'boolean'
        ...
        if (p !== void 0) {
          let x = new pe({ fallbackUrls: p.entries, serwist: this });
          c.forEach((J) => {
            J.handler instanceof _ &&
              !J.handler.plugins.some((Qe) => 'handlerDidError' in Qe) &&
              J.handler.plugins.push(x);
          });
        }
        for (let x of c) this.registerCapture(x.matcher, x.handler, x.method);
      }
      d && $e();
    }
    ...
    addToPrecacheList(e) {
      ...
      for (let s of e) {
        ...
        (this._urlsToCacheKeys.set(a, n), this._urlsToCacheModes.set(a, o));
      }
      if (t.length > 0) {
...
This is generally NOT safe. Learn more at https://bit.ly/wb-precache`;
    ...
    handleInstall(e) {
      return (
        ...
        Z(e, async () => {
            ...
            await je(
              ...
              async ([a, o]) => {
                let i = this._cacheKeysToIntegrities.get(o),
                  c = this._urlsToCacheModes.get(a),
                  l = new Request(a, {
                    integrity: i,
                    cache: c,
          ...
          let { updatedURLs: s, notUpdatedURLs: n } = t;
    ...
    handleActivate(e) {
      return Z(e, async () => {
        let t = await self.caches.open(this.precacheStrategy.cacheName),
          ...
          a = [];
        for (let o of s) n.has(o.url) || (await t.delete(o), a.push(o.url));
    ...
    handleRequest({ request: e, event: t }) {
      ...
      let d;
      try {
        d = i.handle({ url: s, request: e, event: t, params: a });
      } catch (m) {
        d = Promise.reject(m);
      }
      let p = o?.catchHandler;
      return (
    ...
    findMatchingRoute({ url: e, sameOrigin: t, request: s, event: n }) {
      ...
      for (let o of a) {
        let i,
          c = o.match({ url: e, sameOrigin: t, request: s, event: n });
        if (c)
          return (
            (i = c),
...
var me = { rscPrefetch: 'pages-rsc-prefetch', rsc: 'pages-rsc', html: 'pages' },
  ze = [
    {
    ...
    {
      matcher: /\/api\/auth\/.*/,
      handler: new b({ networkTimeoutSeconds: 10 }),
    },
    {
      matcher: ({ sameOrigin: r, url: { pathname: e } }) =>
        r && e.startsWith('/api/'),
      method: 'GET',
      handler: new f({
        cacheName: 'apis',
    ...
    {
      matcher: ({ request: r, url: { pathname: e }, sameOrigin: t }) =>
        r.headers.get('RSC') === '1' &&
        r.headers.get('Next-Router-Prefetch') === '1' &&
        t &&
        !e.startsWith('/api/'),
      handler: new f({
        cacheName: me.rscPrefetch,
        plugins: [new h({ maxEntries: 32, maxAgeSeconds: 1440 * 60 })],
      }),
    },
    {
      matcher: ({ request: r, url: { pathname: e }, sameOrigin: t }) =>
        r.headers.get('RSC') === '1' && t && !e.startsWith('/api/'),
      handler: new f({
        cacheName: me.rsc,
        plugins: [new h({ maxEntries: 32, maxAgeSeconds: 1440 * 60 })],
      }),
    ...
    {
      matcher: ({ url: { pathname: r }, sameOrigin: e }) =>
        e && !r.startsWith('/api/'),
      handler: new f({
        cacheName: 'others',
        plugins: [new h({ maxEntries: 32, maxAgeSeconds: 1440 * 60 })],
    ...
    {
      matcher: ({ sameOrigin: r }) => !r,
      handler: new f({
        cacheName: 'cross-origin',
        plugins: [new h({ maxEntries: 32, maxAgeSeconds: 3600 })],
        networkTimeoutSeconds: 10,
      }),
    },
...
var Pt = new z({
  ...
  runtimeCaching: [
    {
      matcher: ({ url: r }) =>
        r.origin === 'https://vercel.live' &&
        r.pathname === '/_next-live/feedback/feedback.js',
      handler: new b({
        plugins: [
  ...
  fallbacks: {
    entries: [{ url: '/', matcher: ({ request: r }) => r.mode === 'navigate' }],
  },
});
Pt.addEventListeners();
