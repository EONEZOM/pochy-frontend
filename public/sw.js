var w = [
  { revision: '10db1bceadfd9a642ea329618343d226', url: '/manifest.json' },
  ...
  { revision: '2a7307b882679f50ffd1f7223b207a46', url: '/icons/wish.png' },
  { revision: '03a9df958a39cfc8ec6e1948c6f69b8b', url: '/icons/warning.svg' },
  { revision: '4991d25bc0575a2dfd388537034da375', url: '/icons/README.md' },
  { revision: '5be34f1ac7ca7a136cee465cf4dfb031', url: '/icons/profile.png' },
  { revision: '37256433d3e4d51392f49e23f5d54792', url: '/icons/imgplus.svg' },
  { revision: 'a8e5947bc4db215d315109f5e20358f6', url: '/icons/home.svg' },
  { revision: 'cd389ecce6970bc68ac10f49e338e8e4', url: '/icons/filter.svg' },
  { revision: '3a0fe4baacfc8b49576e3a6ffcc1ec61', url: '/icons/feed.svg' },
...
function ot(r) {
  return rt().includes(r)
    ? function (...e) {
        return (r.apply(ne(this), e), x(this.request))
      }
    : function (...e) {
        return x(r.apply(ne(this), e))
      }
}
function it(r) {
  return typeof r == 'function'
    ? ot(r)
    : (r instanceof IDBTransaction && nt(r), se(r, st()) ? new Proxy(r, ae) : r)
}
function x(r) {
  if (r instanceof IDBRequest) return at(r)
  if (ee.has(r)) return ee.get(r)
  let e = it(r)
  return (e !== r && (ee.set(r, e), $.set(e, r)), e)
}
var ne = (r) => $.get(r)
function I(r, e, { blocked: t, upgrade: s, blocking: a, terminated: n } = {}) {
  let o = indexedDB.open(r, e),
    i = x(o)
  return (
    s &&
      o.addEventListener('upgradeneeded', (c) => {
        s(x(o.result), c.oldVersion, c.newVersion, x(o.transaction), c)
      }),
...
function De(r, e) {
  ...
  let n = async function (o, ...i) {
    ...
    return (
      s && (l = l.index(i.shift())),
      (await Promise.all([l[t](...i), a && c.done]))[0]
    )
  }
  return (te.set(e, n), n)
}
...
async function* ht(...r) {
  ...
  e = e
  let t = new Proxy(e, dt)
  for (Oe.set(t, e), $.set(t, ne(e)); e; )
  ...
  F = class {
    ...
    async getAll() {
      ...
      for (let a of e) {
        ...
        t - a.timestamp > n
          ? await this._queueStore.deleteEntry(a.id)
          : s.push(Pe(a))
      }
      return s
    }
    ...
    async _removeRequest(e) {
      ...
      if (s) {
        ...
        return t - s.timestamp > a ? this._removeRequest(e) : Pe(s)
      }
    }
    ...
    async registerSync() {
      if ('sync' in self.registration && !this._forceSyncFallback)
        try {
          await self.registration.sync.register(`${Ue}:${this._name}`)
        } catch {}
    }
    _addSyncListener() {
      'sync' in self.registration && !this._forceSyncFallback
        ? self.addEventListener('sync', (e) => {
            if (e.tag === `${Ue}:${this._name}`) {
              let t = async () => {
...
var B = class {
    ...
    async cachePut(e, t) {
      ...
      if (!t) throw new u('cache-put-with-no-response', { url: Ne(a.url) })
      ...
      let { cacheName: o, matchOptions: i } = this._strategy,
        ...
        h = l ? await Ee(c, a.clone(), ['__WB_REVISION__'], i) : null
      try {
  ...
  _ = class {
    ...
    async _getResponse(e, t, s) {
      ...
      try {
        if (
          ((a = await this._handle(t, e)), a === void 0 || a.type === 'error')
        )
        ...
        if (n instanceof Error) {
          for (let o of e.iterateCallbacks('handlerDidError'))
            if (
              ((a = await o({ error: n, event: s, request: t })), a !== void 0)
            )
              break
        }
        if (!a) throw n
...
var f = class extends _ {
    ...
    async _handle(e, t) {
      ...
      let i = await t.waitUntil(
        (async () => (await t.waitUntil(Promise.race(a))) || (await o))(),
      )
  ...
  ue = 'GET'
var U = (r) => (r && typeof r == 'object' ? r : { handle: r }),
  g = class {
    handler
    match
    method
    ...
    _useDefaultCacheabilityPluginIfNeeded() {
      ...
      for (let [s, a] of this.plugins.entries())
        a !== r.copyRedirectedCacheableResponsesPlugin &&
          (a === r.defaultPrecacheCacheabilityPlugin && (e = s),
          a.cacheWillUpdate && t++)
      t === 0
...
var j = class extends g {
    constructor(e, t, s) {
      let a = ({ url: n }) => {
        let o = e.exec(n.href)
        if (o && !(n.origin !== location.origin && o.index !== 0))
          return o.slice(1)
      }
      super(a, t, s)
    }
  ...
  Me = (r) => {
    ...
    return (s.searchParams.set(wt, e), { cacheKey: s.href, url: a.href })
  },
  H = class {
    updatedURLs = []
    notUpdatedURLs = []
  ...
  Be = (r, e, t) => {
    ...
    if (r instanceof RegExp) return new j(r, e, t)
...
var yt = 'serwist-expiration',
  ...
  de = class {
    ...
    async setTimestamp(e, t) {
      ...
      let s = {
        ...
        n = (await this.getDb()).transaction(G, 'readwrite', {
          durability: 'relaxed',
        })
  ...
  d = class {
    ...
    _getCacheExpiration(e) {
      ...
      return (
        t || ((t = new he(e, this._config)), this._cacheExpirations.set(e, t)),
        t
      )
    }
  ...
  je = ({ serwist: r, cacheName: e, ...t }) => {
    let s = N.getGoogleAnalyticsName(e),
      a = new M(Et, { maxRetentionTime: _t, onSync: Dt(t) }),
      n = [At(s), qt(s), Tt(s), ...St(a)]
  ...
  Ut = async (r, e) => {
    try {
      ...
      let s = Ct(t),
        a = await e.blob(),
        n = Ot(a, s.start, s.end),
        o = a.slice(n.start, n.end),
        i = o.size,
        c = new Response(o, {
          status: 206,
  ...
  P = class {
    cachedResponseWillBeUsed = async ({ request: e, cachedResponse: t }) =>
      t && e.headers.has('range') ? await Ut(e, t) : t
  },
  q = class extends _ {
    async _handle(e, t) {
      let s = [],
      ...
      if (
        ...
        s
          ...
          : self.addEventListener('message', (v) => {
              v.data && v.data.type === 'SKIP_WAITING' && self.skipWaiting()
            }),
        i && Re(),
        e && e.length > 0 && this.addToPrecacheList(e),
        R.cleanupOutdatedCaches && be(D.cacheName),
        this.registerRoute(new fe(this, J)),
        R.navigateFallback &&
          this.registerRoute(
            new K(this.createHandlerBoundToUrl(R.navigateFallback), {
        ...
        if (p !== void 0) {
          let v = new pe({ fallbackUrls: p.entries, serwist: this })
          c.forEach((z) => {
            z.handler instanceof _ &&
              !z.handler.plugins.some((Je) => 'handlerDidError' in Je) &&
              z.handler.plugins.push(v)
          })
        }
        for (let v of c) this.registerCapture(v.matcher, v.handler, v.method)
      }
      h && $e()
    }
...
var me = { rscPrefetch: 'pages-rsc-prefetch', rsc: 'pages-rsc', html: 'pages' },
  Qe = [
    ...
    {
      matcher: /\/api\/auth\/.*/,
      handler: new S({ networkTimeoutSeconds: 10 }),
    },
    {
    ...
    },
    {
      ...
      handler: new f({
        ...
        plugins: [new d({ maxEntries: 32, maxAgeSeconds: 1440 * 60 })],
      }),
    },
    {
      matcher: ({ request: r, url: { pathname: e }, sameOrigin: t }) =>
    ...
    },
    {
      ...
      handler: new f({
        ...
        plugins: [new d({ maxEntries: 32, maxAgeSeconds: 3600 })],
        networkTimeoutSeconds: 10,
      }),
    },
    { matcher: /.*/i, method: 'GET', handler: new S() },
  ]
var kt = new Q({
  precacheEntries: w,
  skipWaiting: !0,
