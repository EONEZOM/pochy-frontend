...
5. 화장품이 없으면 confidence를 0에 가깝게 하고 bbox는 전체 이미지(0,0,1,1)로 두세요.
6. 손·손가락이 이미지에 보이면 has_hand: true, 없으면 false.
7. 마크다운 없이 순수 JSON만 출력하세요.`;
      ...
      messages: [
        { role: 'system', content: SYSTEM_PROMPT },
        {
          ...
          content: [
            {
              type: 'text',
              text: `이미지 ${images.length}개 각각에서 화장품 용기만의 bbox를 반환해줘. 손과 배경은 제외해.`,
            },
